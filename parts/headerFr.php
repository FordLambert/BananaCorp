<!--This is Header ONLY, for the french version-->
      ...
      <div class="container-fluid row"><!--Start of contain everything (see footer for end)-->
        ...
        <header class="col-xs-12 text-center">
          <nav class="row">
              ...
              <div class="col-md-1">
                <a href="index.php" class="col-md-1 col-sm-6"><img src="pictures/fr.png" alt="FR"></a>
                </br>
                <a href="home.php" class="col-md-1 col-sm-6"><img src="pictures/eng.png" alt="ENG"></a>
              </div>
            </nav>
